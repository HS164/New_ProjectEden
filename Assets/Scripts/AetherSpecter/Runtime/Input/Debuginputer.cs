...
//     version 1.14.0
//     from Assets/Scripts/AetherSpecter/Runtime/Input/DebugInputer.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/AetherSpecter/Runtime/Input/DebugInputer.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @DebugInputer: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@DebugInputer()
    {
        UnityEngine.Debug.Assert(!m_DebugMenu.enabled, "This will cause a leak and performance issues, DebugInputer.DebugMenu.Disable() has not been called.");
    }
    ...
    {
        private @DebugInputer m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DebugMenuActions(@DebugInputer wrapper) { m_Wrapper = wrapper; }
        /// <summary>
