...
//     version 1.14.0
//     from Assets/Scripts/AetherSpecter/Runtime/Input/DebugController.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/AetherSpecter/Runtime/Input/DebugController.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @DebugController: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""DebugMenu"",
            ""id"": ""0980075f-6c6f-4dd4-80b2-1eb77199cf18"",
            ""actions"": [
                {
                    ""name"": ""Open"",
                    ""type"": ""Button"",
                    ""id"": ""40d5b1c7-7a73-4263-a941-1cf1a0000457"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Close"",
                    ""type"": ""Button"",
                    ""id"": ""45f45273-3f2a-4f42-a3ea-22bdbfb680ee"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c3138e02-0a10-4e57-931a-89a585fda0cc"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""720c5b4e-21a5-49b1-8031-3e892454d35c"",
                    ""path"": ""<Keyboard>/slash"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""15ab0952-e130-4b93-b5cd-293fb71b6f7c"",
    ...
    ""controlSchemes"": []
        ...
        m_DebugMenu_Open = m_DebugMenu.FindAction("Open", throwIfNotFound: true);
        m_DebugMenu_Close = m_DebugMenu.FindAction("Close", throwIfNotFound: true);
    }

    ~@DebugController()
    {
        UnityEngine.Debug.Assert(!m_DebugMenu.enabled, "This will cause a leak and performance issues, DebugController.DebugMenu.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_DebugMenu_Open;
    private readonly InputAction m_DebugMenu_Close;
    /// <summary>
    /// Provides access to input actions defined in input action map "DebugMenu".
    /// </summary>
    public struct DebugMenuActions
    {
        private @DebugController m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DebugMenuActions(@DebugController wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "DebugMenu/Open".
        /// </summary>
        public InputAction @Open => m_Wrapper.m_DebugMenu_Open;
        /// <summary>
        /// Provides access to the underlying input action "DebugMenu/Close".
        /// </summary>
        public InputAction @Close => m_Wrapper.m_DebugMenu_Close;
        /// <summary>
